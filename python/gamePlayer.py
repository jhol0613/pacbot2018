...
ODOMETRY_LEFT_TURN_THRESHOLD = 190 # odometer cutoff for finishing left turn
...
FRONT_SENSOR_THRESHOLD_2 = 7 # minimum sensor value before stopping forward motion
INTER_THRESHOLD_SPEED = 18 # speed to travel after activating first front threshold
